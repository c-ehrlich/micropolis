...
## Explicitly Deferred Menu/Non-Gameplay Sound Stems (2026-02-11)

The following stems are intentionally deferred from gameplay parity scope. They are either emitted from Tcl UI/menu interactions (not C simulation `MakeSound` gameplay callsites) or are legacy sound-server aliases that are not used by the OLPC/Sugar runtime path.

| Deferred stems | Classification | Source evidence | Defer rationale |
| --- | --- | --- | --- |
| `airport`, `bulldozer`, `chalk`, `coal`, `com`, `eraser`, `fire`, `ind`, `nuclear`, `park`, `police`, `query`, `rail`, `res`, `road`, `seaport`, `stadium`, `wire`, `zone`, `build` | Menu/tool-mode selection sounds | `ref/micropolis/res/micropolis.tcl:317`, `ref/micropolis/res/micropolis.tcl:4442`, `ref/micropolis/res/micropolis.tcl:4473`, `ref/micropolis/res/micropolis.tcl:4573`, `ref/micropolis/res/weditor.tcl:472` | Emitted by palette and pie-menu label previews (`mode` channel), not by C gameplay simulation callsites. |
| `aaah`, `boing`, `computer`, `oop`, `quackquack`, `skid`, `woosh` | Menu/dialog/navigation feedback sounds | `ref/micropolis/res/micropolis.tcl:4364`, `ref/micropolis/res/micropolis.tcl:4450`, `ref/micropolis/res/micropolis.tcl:4481`, `ref/micropolis/res/micropolis.tcl:4931`, `ref/micropolis/res/micropolis.tcl:5173`, `ref/micropolis/res/micropolis.tcl:5238`, `ref/micropolis/res/micropolis.tcl:5302`, `ref/micropolis/res/wnotice.tcl:114`, `ref/micropolis/res/wnotice.tcl:121`, `ref/micropolis/res/weditor.tcl:472` | UI affordance sounds for pie navigation, dialogs, and widget actions; not authoritative simulation gameplay audio. |
| `beep`, `bop`, `cuckoo`, `explosion-hi`, `honkhonk-hi`, `ignition`, `quack`, `whip` | Legacy/alias assets outside active gameplay path | `ref/micropolis/res/sound.tcl:1`, `ref/micropolis/res/sound.tcl:118`, `ref/micropolis/res/sound.tcl:121`, `ref/micropolis/res/sound.tcl:122`, `ref/micropolis/res/sound.tcl:123`, `ref/micropolis/res/sound.tcl:124`, `ref/micropolis/res/sound.tcl:134`, `ref/micropolis/res/sound.tcl:135` | Declared in original Tcl/X sound-server mapping (`sound.tcl`) and retained as historical/alias files; deferred unless runtime parity scope expands beyond gameplay. |
