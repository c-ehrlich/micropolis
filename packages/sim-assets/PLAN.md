...
- [x] 2026-02-08: Regenerated `packages/sim-assets/src/generated/assets-manifest.ts` on the branch to remove stale formatting drift, then re-verified generator no-op stability via same-file hash equality across consecutive reruns.
